...
public class MainController {
    ...
    private ProgramState   CurentState;
    ...
    private void initialize(){
        ...
        this.runOneStepButton.setOnAction(actionEvent -> {runOneStep(this.selectController.getExamplesListView().getSelectionModel().getSelectedItems().get(0));
                                                            showDataForSelectedProgramState(CurentState);});
    ...
    private void showDataForSelectedExample(RunExampleCommand example){
        ...
        List<ProgramState> programStates = example.getController().getRepository().getProgramList();
        ...
        ListInterface<ValueInterface> output = this.selectedProgram.getOut();
    ...
    private void showDataForSelectedProgramState(ProgramState program){
        ...
        StackInterface<StatementInterface> executionStack = program.getExeStack();
        DictionaryInterface<String, ValueInterface> symbolTable = program.getSymbolTableStack().top();
